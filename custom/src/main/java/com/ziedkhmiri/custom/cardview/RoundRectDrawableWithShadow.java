...
import com.ziedkhmiri.custom.R;
/**
...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.opt_round_card_view_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.opt_round_card_view_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.opt_round_card_view_compat_inset_shadow);
